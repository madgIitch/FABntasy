...
export default async function MarketPage({searchParams}:{searchParams:Promise<{league?:string}>}) {
  ...
  return <CanastioMarket players={players} updatedAt={prices[0]?.updatedAt} market={{leagueId:league.id,leagueName:league.name,balanceCredits:market.balanceCredits,clausesOpen:market.clausesOpen,clauseCutoffAt:market.clauseCutoffAt,serverNow:market.serverNow}}/>;
}
