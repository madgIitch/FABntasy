...
const minutes = new Intl.NumberFormat("es-ES", { minimumFractionDigits: 1, maximumFractionDigits: 1 });
const formatDate = (value: Date | string) => date.format(new Date(value));
const formatMinutes = (value: { toString(): string } | null) => value === null ? "–" : minutes.format(Number(value.toString()));
