...
type Props = { mode: "login" | "register" | "reset" | "update"; action: (state: AuthState, data: FormData) => Promise<AuthState> };
const copy = {
...
export function AuthForm({ mode, action }: Props) {
  ...
  return <main className="auth-page">
    ...
    <section className="auth-panel">
      <p className="eyebrow">Cuenta FABntasy</p><h1>{title}</h1><p>{detail}</p>
