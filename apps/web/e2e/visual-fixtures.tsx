...
async function boot(){let view:ReactNode;
 ...
 case "market":view=<CanastioMarket players={players} updatedAt={now} market={{leagueId:"demo",leagueName:"Los del viernes",balanceCredits:9000000,clausesOpen:true,clauseCutoffAt:now}}/>;break;
