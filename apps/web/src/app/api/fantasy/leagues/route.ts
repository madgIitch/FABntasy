...
export async function POST(request: Request) { try { return leagueOk(await createLeague(await requireLeagueActor({ onboarding: true }), await request.json()), 201); } catch (e) { return leagueError(e); } }
