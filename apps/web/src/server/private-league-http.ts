...
export async function requireLeagueActor() { const user = await getServerUser(); if (!user) throw new LeagueServiceError("AUTH_REQUIRED", 401); return { authUserId: user.id }; }
