...
export type LeagueErrorCode = "AUTH_REQUIRED" | "LEAGUE_NOT_FOUND" | "COMPETITION_DISABLED" | "INVALID_CREDENTIALS" | "PASSWORD_REQUIRED" | "RATE_LIMITED" | "INVITE_INVALID" | "INVITE_EXPIRED" | "INVITE_REVOKED" | "ALREADY_MEMBER" | "LEAGUE_FULL" | "OWNER_CANNOT_LEAVE" | "CONFIRMATION_REQUIRED" | "VERSION_CONFLICT" | "FEATURE_DISABLED" | "SERVICE_UNAVAILABLE" | "INVALID_INPUT";
