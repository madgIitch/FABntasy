...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        active_minutes = int(os.getenv("FAB_SCHEDULER_ACTIVE_MINUTES", "10"))
        ...
        if not 5 <= active_minutes <= 15:
            raise ValueError("FAB_SCHEDULER_ACTIVE_MINUTES must be between 5 and 15")
