...
- **eligibility_and_cadence:** Se consultan partidos marcados como comenzados y partidos cuyo horario caiga en la ventana activa, para tolerar retrasos del endpoint general. La cadencia reutiliza el intervalo activo configurable de 5–15 minutos, locks, rate limit, backoff y circuit breaker existentes; al finalizar vuelve a la cadencia no-live.
